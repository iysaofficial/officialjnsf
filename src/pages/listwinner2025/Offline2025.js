              ...
              <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                <div className="m-2 text-justify text-sm">
                  ...
                  <a className="font-bold">
                    {/* Lokasi Venue: {" "}   */}
                    <a
                      href="https://drive.google.com/file/d/18fYlevOZql98OxeqMoLg6GTwYhA6SiMt/view?usp=sharing"
                      target="_blank"
                    >
                      Klik Disini
                    </a>
              ...
              <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                <div className="m-2 text-justify text-sm">
                  ...
                  <a className="font-bold">
                    {/* Lokasi Venue: {" "}   */}
                    <a
                      href="https://drive.google.com/file/d/1Ux8TIQobHRmBAN2AhrGUK2HuUO712byM/view?usp=sharing"
                      target="_blank"
                    >
                      Klik Disini
                    </a>
              ...
              <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                <div className="m-2 text-justify text-sm">
                  ...
                  <a className="font-bold">
                    {/* Lokasi Venue: {" "}   */}
                    <a
                      href="https://drive.google.com/file/d/1KChUUINV_qhEo9O5YWSyS_TubXF89qjq/view?usp=sharing"
                      target="_blank"
                    >
                      Klik Disini
                    </a>
