      ...
      <footer>
        <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
          ...
          <div className="grid sm:grid-cols-12 gap-5 py-9 md:py-12 border-t border-gray-200 lg:ml-11">
            ...
            {/* 4th block */}
            <div className="col-span-12 text-center mx-auto lg:col-span-3 font-bold uppercase text-[#101084]">
                ...
                <ul className="flex justify-center mb-4 md:mb-0">
                  <li>
                    <a
                      ...
                      className="flex justify-center items-center text-[#101084] hover:text-gray-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out"
                  ...
                  <li className="ml-4">
                    <a
                      ...
                      className="flex justify-center items-center text-[#101084] hover:text-gray-500 hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out"
                      aria-label="Youtube"
                    >
                      <svg
                        className="w-8 h-8 fill-current"
